...
class Ui_Dialog(object):
    ...
    def update_score(self, total_score):
        self.finalscore.setText(str(total_score))

    def show_total_score_dialog(self, total_score):
        msg_box = QMessageBox()
        msg_box.setWindowTitle("Total Score")
        msg_box.setText(f"Your total score is: {total_score}")
        msg_box.exec_()
