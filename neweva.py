...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 170, 801, 471))
        ...
        self.players_lw = QtWidgets.QListWidget(self.layoutWidget)
        ...
        self.scores_lw_2 = QtWidgets.QListWidget(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 90, 791, 36))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.selectteam_cb = QtWidgets.QComboBox(self.layoutWidget1)
        ...
        self.selectmatch_cb = QtWidgets.QComboBox(self.layoutWidget1)
    ...
    def changedname(self, t):
        ...
        players = matchcur.execute(f"SELECT players, value FROM teams WHERE name='{t}';").fetchall()
        logging.debug('Players:', players)
        self.players_lw.addItems([player[0] for player in players])
        self.scores_lw_2.addItems([str(player[1]) for player in players])
    ...
    def final_score(self):
        ...
        logging.debug(f"Selected match: {t}")

        selected_team = self.selectteam_cb.currentText()
        logging.debug(f"Selected team: {selected_team}")

        z = matchcur.execute(f"SELECT value from teams WHERE name='{selected_team}';")
        selected_players_points = z.fetchall()

        if not selected_players_points:
            logging.error(f"No data found for team: {selected_team}")
            return

        for player_points in selected_players_points:
           total_score += player_points[0]

        logging.debug(f"Total score for {selected_team}: {total_score}")
