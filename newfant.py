...
from rule import Ui_Dialog as RuleDialog
...
fant = sqlite3.connect('fntsy_crc.db')
...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        rules_action = QtWidgets.QAction("Rules!",MainWindow)
        rules_action.triggered.connect(self.show_rules)
        help_menu.addAction(rules_action)

        self.ruleDialog = QtWidgets.QDialog()
        self.rule_screen = RuleDialog()
        self.rule_screen.setupUi(self.ruleDialog)
    ...
    def retranslateUi(self, MainWindow):
        ...
        help_menu = self.menubar.addMenu(_translate("MainWindow", "Help"))
        rules_action = QtWidgets.QAction(_translate("MainWindow", "Rules"), MainWindow)
        rules_action.triggered.connect(self.show_rules)
        help_menu.addAction(rules_action)


    def show_rules(self):
        self.ruleDialog.show()
    ...
    def openteam(self):
        ...
        for i in x:
            ...
            if y != 0 and y[0] != 0:
                ...
                print(f"Skipping player {i[0]} because value is None")

        logging.debug(f"Player scores: {score}")
        total_score = sum(score)

        logging.debug(f"Total score: {total_score}")

        self.ui.update_score(total_score)
        self.ui.show_total_score_dialog(total_score)
        self.selectedplayers_lw.clear()
        ...
        self.used_points = total_score
        self.avail_points = 1000 - total_score
        self.points_available.setText(str(self.avail_points))
        self.points_used.setText(str(self.used_points))
